...
const AUTO_LOCK_ERRORS: Record<ExpenseAutoSource, { edit: string; delete: string }> = {
  commission_release: {
    edit:
      ...
      'via Release/Undo Release on the Commissions page.',
    delete: 'This expense was generated by a commission release — undo the release on the Commissions page to remove it.',
  },
};
